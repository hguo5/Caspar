...
for row in training_raw:
    ...
    training_with_label.append((row[2], r, 0))
sys.stdout.write('#Training set: {}\n'.format(len(training_with_label)))
sys.stdout.write('#For training: {}\n'.format(int(len(training_with_label) * TRAINING_RATIO)))
...
save_path = saver.save(sess, 'model/binary_bilstm.model')
